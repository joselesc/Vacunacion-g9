...
public class CiudadanoPrevioVista extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jMICambioDeFecha = new javax.swing.JMenuItem();
        ...
        jMConsulta.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        jMConsulta.add(jMIFechaVacunacion);

        jMICambioDeFecha.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jMICambioDeFecha.setText("CambioDeFecha");
        jMICambioDeFecha.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMICambioDeFechaActionPerformed(evt);
            }
        });
        jMConsulta.add(jMICambioDeFecha);
    ...
    private void jMIFechaVacunacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMIFechaVacunacionActionPerformed
        ...
        EscritorioCiudadano.removeAll();
        EscritorioCiudadano.repaint();
        FechaDeVacunacionVista fv = new FechaDeVacunacionVista();
        setContentPane(EscritorioCiudadano);
        setSize(1212, 966);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        fv.setVisible(true);
        EscritorioCiudadano.add(fv);
        EscritorioCiudadano.moveToFront(fv);  
    }//GEN-LAST:event_jMIFechaVacunacionActionPerformed

    private void jMICambioDeFechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMICambioDeFechaActionPerformed
     
        
    }//GEN-LAST:event_jMICambioDeFechaActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JDesktopPane EscritorioCiudadano;
    private javax.swing.JMenu jMConsulta;
    private javax.swing.JMenuItem jMICambioDeFecha;
